...
📚 Currently in a **professional retraining program as *IT specialist for application development***,  
while combining this journey with my **years of private, hands-on experience in IT-Security**.  

</div>

<p align="center">
  <img src="https://github.com/cyseckev/CySecKev/blob/uploads/animatedbanner5.gif?raw=true" 
...
- **Practical DevOps, Networking & Scripting**  
- **Modern Webdevelopment & Secure Design**  

🌍 Mission-driven by: *Building privacy-first, resilient systems that protect what matters most.*  

---

## 🛡️ Areas of Expertise
- 🌐 **Network Security, IDS/IPS & Traffic Analysis**  
- 🧩 **OPSEC & Anonymity Hardening** (Qubes OS, Whonix, Tails, VPN/WireGuard-Chains)  
- 🖥️ **Cross-Platform Environments** (Linux-first, with solid Windows knowledge)  
- 🛠️ **Software Development** (Python, Bash, Secure Coding Practices)  
- 🎨 **Webdesign & Webdevelopment** (security-conscious front & backend concepts)
- 🎯 **Red Teaming & Penetration Testing**  
- 🕵️ **Vulnerability Research & Exploit Development**  
- 🔐 **Cryptography & Secure Communication (SSH, GPG, TLS)**  
...
**Operating Systems**  
![Kali](https://img.shields.io/badge/-Kali%20Linux-557C94?logo=kali-linux&logoColor=white)
![Qubes](https://img.shields.io/badge/-Qubes%20OS-2E3440?logo=qubes-os&logoColor=white)
...
6. ⚡ [**Disable Windows Telemetry & Data-Collection**](https://github.com/CySecKev/Disable-Windows-Telemetry-Data-Collection) – Harden Windows privacy & disable telemetry
