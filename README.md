...
**Red Teaming, Pentesting, Vulnerability Research & OPSEC Hardening**.  

💻 My daily focus: **Linux Security, Network Defense, Anonymity Techniques & Secure Lab Environments**.  
🌍 Driven by the vision of **privacy-first architectures** and resilient security systems.  
...
- 🧩 OPSEC & Anonymity Hardening (Qubes OS, Whonix, Tails, VPN-Chains)  
- 🖥️ Secure Lab Environments with Kali, Debian, Hardened Windows  
...
![BurpSuite](https://img.shields.io/badge/-BurpSuite-FF6F00?logo=burpsuite&logoColor=white)
